...
DATA_DIR = os.path.abspath(os.path.join(__file__, '..', 'Data', 'gender-recognition-200k-images-celeba', 'Dataset'))
MODEL_SAVE_DIR = os.path.abspath(os.path.join(__file__, '..', 'output'))
os.makedirs(MODEL_SAVE_DIR, exist_ok=True)
MODEL_SAVE_PATH = os.path.join(MODEL_SAVE_DIR, 'gender_classification_model.keras')
